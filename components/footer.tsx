    ...
    <div>
      <p>
        ...
        <Link href={path} locale="ja">
          <a
            style={{
              fontWeight:
                location.hostname === "nextmeats.co.jp" ? "bold" : "normal",
            }}
          >
            日本
          </a>
        ...
        <Link href={path} locale="en-US">
          <a
            style={{
              fontWeight:
                location.hostname === "nextmeats.us" ? "bold" : "normal",
            }}
          >
            United States
          </a>
        ...
        <Link href={path} locale="zh-TW">
          <a
            style={{
              fontWeight:
                location.hostname === "nextmeats.tw" ? "bold" : "normal",
            }}
          >
            台湾
          </a>
      ...
      <p>
        ...
        <Link
          ...
          locale={false}
        >
          <a style={{ fontWeight: languageCode === "jp" ? "bold" : "normal" }}>
            日本語
          </a>
        </Link>{" "}
        /{" "}
        <Link
          ...
          locale={false}
        >
          <a style={{ fontWeight: languageCode === "en" ? "bold" : "normal" }}>
            English
          </a>
        </Link>{" "}
        /{" "}
        <Link
          ...
          locale={false}
        >
          <a style={{ fontWeight: languageCode === "zh" ? "bold" : "normal" }}>
            中文
          </a>
        </Link>
      </p>
