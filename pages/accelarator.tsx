...
const getText = (locale: LanguageCode) => {
  return {
    ...
    target_1: {
      ...
      tw: "利用原材料、加工、调味和营养学方法等技术，打开前所未有的人造肉研发道路。",
    }[locale],
    target_2: {
    ...
    target_explanation: {
      ...
      tw: "除上述条件外，在人造肉领域有望做出任何创新的企业、个人或研究人员都欢迎加入我们的计划。",
    }[locale],
    schedule_h: {
      jp: "スケジュール",
      en: "SCHEDULE",
    ...
    merit_1: {
      ...
      tw: "人造肉的日式烤肉“ NEXT 烧肉系列”在日本连锁店推出后，受到多家电视节目的邀约报道，Next Meats作为日本人造肉品牌，也迅速在海外打开知名度。在植物替代肉的消费领域，可以利用Next Meats的品牌影响力进军国际市场。",
    }[locale],
    merit_2_h: {
      jp: "ノウハウ・技術",
    ...
    merit_2: {
      ...
      tw: "我们在开发各类人造肉产品（例如烤肉、牛肉盖饭和汉堡肉）的过程中积累的经验和技术，可以为您开发产品提供专业而有力的支持。",
    }[locale],
    merit_3_h: {
      jp: "スピード",
    ...
    merit_3: {
      ...
      tw: "帮助您高效做出产品决策和试验，推动商业化进程。在Next Meats加速器服务的体验过程中获得的经验和思考，亦可活用于公司新业务领域。",
    }[locale],
    merit_4_h: {
      jp: "環境への取り組み",
      en: "CSR Contribution",
    ...
    merit_4: {
      ...
      tw: "Next Meats“不做地球的终结者”的初心和理念，可以应用于企业CSR项目的传播。",
    }[locale],
    merit_5_h: {
      jp: "ネットワーク",
      en: "Network",
    ...
    merit_5: {
      ...
      tw: "Next Meats已面向美国、中国台湾、越南和世界各区推出业务。 于2021年1月，在OTCBB（美国）上市。",
    }[locale],
    merit_6_h: {
      jp: "資金",
      en: "Funding",
    ...
    merit_6: {
      ...
      tw: "Next Meets可以为商业化进程中，PoC（概念验证）产生的各种费用和研究成本提供资金援助。必要时也考虑对参与公司的项目投资入股。",
    }[locale],
    judge_h_1: {
      jp: "ネクストミーツ",
      en: "NEXT MEATS",
    ...
    judge_5: {
      ...
      tw: "He was the COO at an AI and 3D printing startup in Tokyo, Japan which succeeded in being acquired by a company listed on the Tokyo Stock Exchange in September 2017. He was in charge of not only as a COO but also as an Executive Director of Global Business Development. From the experience of the M&A, he has been advising not only Japanese but also international startups. Previously, Masafumi lived in Singapore for about 3 years and experienced two companies. One was in charge as a Managing Director, and the other was in charge as a CEO. He succeeded in several M&As and alliances in ASEAN. He began his career in Singapore at Reeracoen Singapore Pte, Ltd. He gathered fellows from all over the world and built a multinational team, including Ireland, Spain, China, Malaysia, the Philippines, India, and Singapore.",
    }[locale],
    judge_6_h: {
      jp: (
        <>
    ...
    judge_6: {
      ...
      tw: "Started his career as CPA and provided IPO consulting, M&A and Audit. Launched innovation focused subsidiary in Deloitte Japan in 2010 as a co-founder and expanded to over 160 members with 4 presences in the world. Promoted whole company businesses as a COO. Business leader with 13 years of experience in business planning, cross-border alliance and innovation strategy consulting. Moved to US in 2015 and created a lot of Japanese MNCs new businesses with local startups. Presented as the main and special speaker in large scale global tech conferences such as Automotive World 2019, Wearable Expo 2017-2019 and AI Conference 2017.",
    }[locale],
    contact: {
      jp: <>受付終了</>,
