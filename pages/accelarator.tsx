          ...
          content={
            {
              ...
              zh: staticPath.img.accelarator.header_tw_pc_jpg,
            }[languageCode]
          }
        />
      </Head>
              ...
              src={
                {
                  ...
                  zh: staticPath.img.accelarator.header_tw_mobile_jpg,
                }[languageCode]
              }
              alt=""
              width={900}
...
const getText = (locale: LanguageCode) => {
  return {
    ...
    purpose_1: {
      jp: "参加者それぞれが持っている知見や技術を持ち合わせることで代替肉事業にイノベーションを起こします。",
      en: "By combining the knowledge and technologies of all participants, we can spark innovation on an unprecedented scale in the alternative meat industry.",
      zh: "通过整合每个参与者持有的知识和技术，在植物替代肉领域掀起创新潮流。",
    }[locale],
    purpose_2_h: {
      jp: "地球をよくするための共創",
    ...
    purpose_2: {
      jp: "競争ではなく共創することを目指し、地球をよくしていくために手を取り合っていきます。",
      en: "Rather than competing amongst one another, if capable and passionate entities worked together we can improve the global environment much more efficiently.",
      zh: "以共同创造而非竞争为目标指向，携手并肩改善地球的生存状态。",
    }[locale],
    purpose_3_h: {
      jp: "世界市場獲得",
    ...
    purpose_3: {
      ...
      en: "By combining the power of all participating companies, we can and will expand and shape the global alternative meat market.",
      zh: "企业的全体参与者紧密结合，进军全球市场。",
    }[locale],
    target_h: {
      jp: (
        <>
    ...
    target_1: {
      jp: "原料・加工・調味・栄養学的なアプローチなどの技術を活用し、今までにない代替肉開発に貢献する。",
      en: "Let us know about your innovative approaches in food processing methods, flavoring, the supply and selection of raw materials, and nutritional insights.",
      zh: "利用原材料、加工、调味和营养学方法等技术，打开前所未有的人造肉研发道路。",
    }[locale],
    target_2: {
      jp: "微細藻類・遺伝子・培養技術などを活用し、新たな代替肉開発に貢献する。",
      en: "Microalgae, cell culturing and genetic modification technology all hold unbound possibility in the development of new alternative meat products. Talk to us about your product development ambitions!",
      zh: "通过利用微藻、基因和培养技术，为人造肉的新研发做出贡献。",
    }[locale],
    target_3: {
      jp: "IoTやブロックチェーンなどの農業技術を活用し、新たな代替肉の原材料の分野で貢献する。",
      en: "Collaborate with your specialty in IoT, blockchain and agricultural technology to discern new raw material prospects and other potentials to be unlocked",
      zh: "利用物联网和区块链等农业技术，为人造肉的原料创新领域做出贡献。",
    }[locale],
    target_4: {
      jp: "機会設備、包装技術などの強みを活かし、代替肉の生産過程の分野で貢献する。",
      en: "Utilize your knowledge on machinery and the packing-processing steps to improve the alternative meat production process!",
      zh: "利用机械设备和包装技术等优势，为人造肉的生产领域做出贡献。",
    }[locale],
    target_explanation: {
      jp: "上記以外でも、代替肉を作っていく上でのイノベーションになればどんな企業、個人、研究者の方でもご参加いただけます。",
      en: "We are open to collaborate with innovative companies, researchers, and individuals even if you do not specialize in alternative meats, if it is in your strong interests to contribute to the research and development of products which will come out of this program.",
      zh: "除上述条件外，在人造肉领域有望做出任何创新的企业、个人或研究人员都欢迎加入我们的计划。",
    }[locale],
    schedule_h: {
      jp: "スケジュール",
      en: "SCHEDULE",
    ...
    merit_1: {
      jp: "代替肉の焼肉「NEXT焼肉シリーズ」を全国チェーンで展開、テレビ番組にも多数取り上げられ、日本をはじめ海外でも代替肉ブランドとして定着しました。植物性代替肉市場におけるネクストミーツのブランド力を使えます。",
      en: 'Next Meats has become established as an alternative meat brand in Japan and overseas for developing the "NEXT Yakiniku Series", the world\'s first alternative meat designed for Yakiniku and served nationwide Barbeque chain in Japan. Next Meats has also received great media coverage and market advantage by swiftly establishing overseas collaborations and facilities, compared to competitors. By collaborating, you can use the brand power of Next Meats in establishing new businesses.',
      zh: "人造肉的日式烤肉“ NEXT 烧肉系列”在日本连锁店推出后，受到多家电视节目的邀约报道，Next Meats作为日本人造肉品牌，也迅速在海外打开知名度。在植物替代肉的消费领域，可以利用Next Meats的品牌影响力进军国际市场。",
    }[locale],
    merit_2_h: {
      jp: "ノウハウ・技術",
    ...
    merit_2: {
      jp: "焼肉、牛丼、ハンバーグといった多様な代替肉製品を開発する中培われたノウハウ、技術を使って商品開発を行えます。",
      en: "We can develop products and offer our extensive know-how and technology cultivated through researching and developing our various alternative meat products such as yakiniku, beef bowl, and hamburger steak.",
      zh: "我们在开发各类人造肉产品（例如烤肉、牛肉盖饭和汉堡肉）的过程中积累的经验和技术，可以为您开发产品提供专业而有力的支持。",
    }[locale],
    merit_3_h: {
      jp: "スピード",
    ...
    merit_3: {
      jp: "迅速に意思決定・テストを行い、商品化まで進められます。ネクストミーツのスピード感を体感することで、自社の新規事業などにも活かせます。",
      en: "We value and pride ourselves in our speed of development. By experiencing the speediness and business style of Next Meats, it will surely be of use in your company's future endeavors.",
      zh: "帮助您高效做出产品决策和试验，推动商业化进程。在Next Meats加速器服务的体验过程中获得的经验和思考，亦可活用于公司新业务领域。",
    }[locale],
    merit_4_h: {
      jp: "環境への取り組み",
      en: "CSR Contribution",
    ...
    merit_4: {
      jp: "ネクストミーツは「地球を終わらせない」を理念に代替肉の開発を行っています。企業のCSR活動としても取り組めます。",
      en: 'Next Meats operates with the mission of "Not letting the Earth end." By collaborating with us, our partners can confidently state their CSR Contributions.',
      zh: "Next Meats“不做地球的终结者”的初心和理念，可以应用于企业CSR项目的传播。",
    }[locale],
    merit_5_h: {
      jp: "ネットワーク",
      en: "Network",
    ...
    merit_5: {
      jp: "アメリカ、台湾、ベトナムとグローバルに事業を展開しています。また、2021年1月にはOTCBB（アメリカ）へ上場しました。",
      en: "We have expanded our business to Taiwan and Vietnam, and are currently working full speed to establish facilities in America, Italy, Singapore, and several other countries. We have gotten listed on the American OTC Market in January of 2021.",
      zh: "Next Meats已面向美国、中国台湾、越南和世界各区推出业务。 于2021年1月，在OTCBB（美国）上市。",
    }[locale],
    merit_6_h: {
      jp: "資金",
      en: "Funding",
    ...
    merit_6: {
      jp: "事業化に向けてのPoC（実証実験）にかかる各種費用や研究費をネクストミーツがサポートすることもできます。必要に応じて出資も検討いたします。",
      en: "Next Meats can also support various costs and research costs for PoC (proof of concept) for commercialization. We will consider investing if necessary.",
      zh: "Next Meets可以为商业化进程中，PoC（概念验证）产生的各种费用和研究成本提供资金援助。必要时也考虑对参与公司的项目投资入股。",
    }[locale],
    judge_h_1: {
      jp: "ネクストミーツ",
      en: "NEXT MEATS",
    ...
    judge_1: {
      jp: "早くから起業した経験を活かし、海外に目を向け、中国深センにて 12 年間様々な事業に携わる。 大企業向けのアクセラレータプログラムや、メディア運営で培った経験を生かし、2020年6月にネクストミーツを設立。現職に至る。国内外のメディアで話題となり日本を代表する代替肉ベンチャーとなる。フェイクミート研究家。中国語ビジネスレベル。代替肉ベンチャーとして開発製造販売、メディア運営を行う。",
      en: "",
      zh: "",
    }[locale],
    judge_2_h: {
    ...
    judge_3: {
      jp: "2008年株式会社インテリジェンス（現パーソルキャリア株式会社）入社。 以来、doda編集部、人材紹介事業部法人営業など、HR転職領域に従事。2015年「eiicon」事業を起案・推進。現在は全国各地の18,000社を超える様々な法人が登録し、日本最大級の企業検索・マッチングプラットフォームとなった「eiicon」を運営するeiicon company の代表を務める。年間60本以上のイベントにおいて講演・モデレートなども務め、多くのアクセラレータープログラムのメンター・審査員等幅広く活動している。 副業マッチングサービス「lotsful」 共同創業者。",
      en: "",
      zh: "",
    }[locale],
    judge_4_h: {
    ...
    judge_4: {
      jp: "大手不動産会社にて社内SEとしてスマホサイトの構築〜タブレットアプリの開発に従事。また、業界初無人店舗端末の構築・運営まで幅広く経験。2014年株式会社インテリジェンスに入社後、アルバイト求人サイト　anのリニューアルプロジェクトを担当。リニューアルによる月次応募の底上げに成功。社内表彰歴多数。その後、eiicon立ち上げ時から参画。サービス全体のマーケティング、プロモーションからWebサイト開発・デザイン～ディレクション、など幅広く、モノづくり全般を担う。",
      en: "",
      zh: "",
    }[locale],
    judge_5_h: {
    ...
    judge_5: {
      jp: "都市銀行で東京にて法人融資を担当、人材紹介会社にてIT支援部、経営企画部、グローバル企画部にて事業開発担当。シンガポール移住後、シンガポール現地にて代表取締役社長を2社務める。東京帰国後、機械学習×3DプリンターのスタートアップでCOO、プロダクト統括責任者、経営企画部執行役員、事業執行役員、海外事業開発部執行役員を歴任、2017年東証一部上場企業にExit。2019年12月、株式会社FinalAim創業。",
      en: "He was the COO at an AI and 3D printing startup in Tokyo, Japan which succeeded in being acquired by a company listed on the Tokyo Stock Exchange in September 2017. He was in charge of not only as a COO but also as an Executive Director of Global Business Development. From the experience of the M&A, he has been advising not only Japanese but also international startups. Previously, Masafumi lived in Singapore for about 3 years and experienced two companies. One was in charge as a Managing Director, and the other was in charge as a CEO. He succeeded in several M&As and alliances in ASEAN. He began his career in Singapore at Reeracoen Singapore Pte, Ltd. He gathered fellows from all over the world and built a multinational team, including Ireland, Spain, China, Malaysia, the Philippines, India, and Singapore.",
      zh: "He was the COO at an AI and 3D printing startup in Tokyo, Japan which succeeded in being acquired by a company listed on the Tokyo Stock Exchange in September 2017. He was in charge of not only as a COO but also as an Executive Director of Global Business Development. From the experience of the M&A, he has been advising not only Japanese but also international startups. Previously, Masafumi lived in Singapore for about 3 years and experienced two companies. One was in charge as a Managing Director, and the other was in charge as a CEO. He succeeded in several M&As and alliances in ASEAN. He began his career in Singapore at Reeracoen Singapore Pte, Ltd. He gathered fellows from all over the world and built a multinational team, including Ireland, Spain, China, Malaysia, the Philippines, India, and Singapore.",
    }[locale],
    judge_6_h: {
      jp: (
        <>
