...
function getText(locale) {
  return {
    title: {
      ja: '世界初となる代替肉のレトルト牛丼\n「ネクスト牛丼1.2」',
      en: 'The world’s very first pre-packaged meat substitute-based gyudon "NEXT Gyudon 1.2"',
    ...
    pr04: {
      ja: '原材料：大豆加工品（脱脂大豆、食塩）（国内製造）、調味液（しょうゆ、砂糖、米発酵調味料、酵母エキス、昆布エキス、食塩、醸造酢、椎茸エキス、ジンジャーパウダー）、たまねぎ、食用なたね油 / 着色料（カラメル色素）、（一部に大豆・小麦を含む）',
      en: 'Ingredients: Processed soybeans (defatted soybeans produced in Japan, salt), seasonings (soy sauce, sugar, fermented rice seasonings, yeast extract, kombu extract, salt, brewed vinegar, shiitake mushroom extract, ginger powder), onion, canola oil, coloring (caramel color). (This product contains soybean and wheat ingredients.)',
      tw: '原料：大豆加工品（脫脂大豆、食鹽）（日本國內製造）、調味醬（醬油、砂糖、米發酵調味料、酵母萃取物、昆布萃取物、食鹽、釀造醋、香菇萃取物、生薑粉）、洋蔥、食用菜籽油 / 著色劑（焦糖色素）、（部分含大豆、小麥）',
    }[locale],
    pr05: {
      ja: '栄養成分表示(100gあたり)：熱量196kcal、たんぱく質4.9g、脂質15.7g、炭水化物8.6g、食塩相当量1.4g',
      en: 'Nutrition facts (per 100g): Calories: 196kcal. Protein: 4.9g. Total fat: 15.7g.\nTotal carbohydrate: 8.6g. Salt equivalent: 1.4g.',
      tw: '營養成分標示（每100g）：熱量196kcal、蛋白質4.9g、脂肪15.7g、碳水化合物8.6g、相當於食鹽含量1.4g',
    }[locale],
    pr06: {
      ja: '※動物性の原料は使用しておりません。パームオイルや、牛骨炭を用いた白砂糖も使用しておらず、工場の生産ラインでも動物性の原料を扱っておりません。ヴィーガンの方にも対応した商品です。',
