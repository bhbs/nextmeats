...
const getText = (languageCode: LanguageCode) => {
  return {
    ...
    explain: {
      ...
      tw: "隨著本公司的擴張並於全球各地成立據點，我們提供各式各樣的職缺，並且能容納多樣化的工作風格。不管你/妳是經驗豐富的專家和科學家，或是熱血的志工和實習生，我們都很高興為你/妳制訂專屬的工作時間表。\n\n目前，本公司在美國、西班牙、意大利、法國、越南、台灣、香港和新加坡各有據點，並正在積極招聘全職夥伴！\n\n如有興趣或有任何疑問，歡迎來信詢問！",
    }[languageCode],
    jobs: [
      {
        job: {
        ...
        description: {
          ...
          tw: "我們需要在食品科學、生物化學、生物工程、農業科學、動物科學或其他相關領域，具備良好研究能力與技術，專心和經驗豐富的研究專員，以協助我們在研發”未來肉“（肉類替代品）的路上穩健邁進！",
        }[languageCode],
      },
      {
        job: {
        ...
        description: {
          ...
          tw: "我們需要具有管理社交媒體經驗，且富有創意和目標導向的行銷專員，以擴大我們在各個社交平台上的影響力。",
        }[languageCode],
      },
      {
        job: {
        ...
        description: {
          ...
          tw: "我們需要富有創造力和致力發揮品牌優勢的設計師/策略師，與龐大的團隊合作，以制定本土化且有效的溝通策略，來聯繫全世界。",
        }[languageCode],
      },
      {
        job: {
        ...
        description: {
          ...
          tw: "我們需要具備良好溝通能力、精力充沛且專注的銷售專員，以進行B2B銷售和建立新的商機，並且維持牢固的企業客戶關係。",
        }[languageCode],
      },
      {
        job: {
      ...
      },
      {
        ...
        description: {
          ...
          tw: "我們需要具備品管經驗的設施/產線品質管理經理，協助監督我們的生產線，以確保產品符合本公司的高品質標準。",
        }[languageCode],
      },
      {
        job: {
        ...
        description: {
          ...
          tw: "我們需要善於規劃和經驗豐富的會計師/行政管理專員，以助團隊運作順利！",
        }[languageCode],
      },
      {
        job: {
        ...
        description: {
          ...
          tw: "我們也歡迎充滿熱情的實習生和志工加入我們，與我們一起奮鬥，努力讓地球免遭徹底的環境災難！",
        }[languageCode],
      },
    ],
    contact: {
